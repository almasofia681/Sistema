...
<?php
 ...
 if($_status=="Payments"){
		...
		echo '<a href="#"  class="btn btn-xs btn-info" onClick="viewNotifications('.$std_index.',\'' . $due_month . '\','.$due_year.','.$notifi_id.')">Ver Detalles</a>';     
              
		
	}
	
	if($_status=="Events"){
		echo '<a href="#"  class="btn btn-xs btn-info" onClick="showNotifyEvent('.$notification_id.')">Ver Detalles</a>';
	}
